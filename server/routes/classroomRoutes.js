...
//         // TODO: if classroom.owner != req.userId -> not allowed to share post on this class
...
// router.get('/request-to-join', async (req, res) => {
...
//         return responseFunction(res, 200, 'OTP sent to the class owner', null, false);
...
//         await Classroom.deleteOne({ _id: joinRequest._id });
